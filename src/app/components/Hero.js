...
const Hero = () => (
  <section className={`${styles.hero} gradient-bg`}>
    <div className={`${styles.heroTextContainer} fade-in-left`}>
      <h1 className={`${styles.heroTitle} hero-gradient hero-name-shine`}>Seth Riley</h1>
    ...
    <div className={`${styles.heroImageContainer} fade-in-right scale-in`}>
      ...
      />
      {/* Enhanced rotating conic ring is handled via .hero-image-elegant::after */}
      {/* Add orbiting dots container */}
      <div className="hero-orbit">
        <span className="hero-orbit-dot dot-sm" style={{ transform: 'translate(-50%, -50%) rotate(15deg)' }} />
        <span className="hero-orbit-dot dot-md" style={{ transform: 'translate(-50%, -50%) rotate(120deg)' }} />
        <span className="hero-orbit-dot dot-lg" style={{ transform: 'translate(-50%, -50%) rotate(240deg)' }} />
      </div>
